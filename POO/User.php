...
class User{
    ...
    //Le tostring pour utiliser afficheNomArticle2
    // public function __toString(): string 
    // {
    //     $date = $this->dateOfBirth->format('d/m/Y');
    //     return "Id : ".$this->idUser . "<br>Prénom : ".$this->firstname . "<br>Nom : ".$this->lastname . "<br>Date de Naissance : ".$date . "<br>Genre : ".$this->gender ."<br>Ville : ".$this->city . "<br>Poids : ".$this->weightKg . " Kg<br>Nombre d'articles écrit : ". sizeof($this->listeArticles). "<br>".$this->afficheNomArticle2() ."<br><br>";
    // }
    ...
    // public function afficheNomArticle2(): string{
    //     $listArtString = "";
    //     if(!empty($this->listeArticles)){
    //         foreach($this->listeArticles as $article){
    //              $listArtString .="Nom article : " .$article->getArticleName() . "<br>";
    //         }
    //     }else{
    //         $listArtString = "Vous n'avez pas créer d'article<br>";
    //     }
    //     return $listArtString;
    // }
